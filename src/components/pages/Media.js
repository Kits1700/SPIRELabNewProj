...
export default function Media()
{
 ...
 <div class ="para">
  ...
  <p>
  IISc and ARTPARK have launched Project Vaani, with initial support from Google, to collect and curate language data that reflect how 100s of millions like Narsamma really speak. These datasets will be open-sourced in Bhashini and other platforms.
